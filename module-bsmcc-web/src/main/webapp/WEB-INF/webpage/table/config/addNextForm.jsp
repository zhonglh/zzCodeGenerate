...
<body class="gray-bg">
							...
							<div class="col-md-12 " style="position:absolute;left:0;top:0;">
								...
								<div class="btn-group hidden-xs" id="exampleTableEventsToolbar"	role="group">
									...
									<div class="row ">
										...
										<input type="hidden" name="projectId" id="projectId" value="${m.projectId}">
										<input type="hidden" name="dbId" id="dbId" value="${m.dbId}">
										<input type="hidden" name="schemaName" id="schemaName" value="${m.schemaName}">
	...
	<script type="text/javascript">
        ...
        init('tables','${ctx}/table/config/tableListByDbConfig/${m.dbId}?schemaName=${m.schemaName}&projectId=${m.projectId}');
