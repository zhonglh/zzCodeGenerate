...
<body class="gray-bg">
				...
				<div class="row row-lg">
					...
					<div class="col-sm-12">
						...
						<div class="btn-group hidden-xs" id="exampleTableEventsToolbar"	role="group">						
							...
							<button id="b1"  msg="从现有数据库中选取表信息" type="button" class="btn btn-outline btn-default" url='${ctx}/db/config/create' onClick="createWin('cgFormHeads',this,800,500);">
								<i class="glyphicon glyphicon-plus" aria-hidden="true"></i>
							</button>							
						
							<button id="b2"  msg="编辑表格信息" type="button" class="btn btn-outline btn-default" url='${ctx}/db/config/--id--/update' onClick="updateWin('cgFormHeads',this);">
								<i class="glyphicon glyphicon-edit" aria-hidden="true"></i>
							</button>								
							
							<button id="b3" type="button" msg="删除无用数据"  class="btn btn-outline btn-default" confirm_message='你确定要删除选择的项目吗?' url='${ctx}/db/config/--id--/delete' onClick="ajaxConfirm('cgFormHeads',this);">
	...
	<script type="text/javascript">
		...
		init('cgFormHeads','${ctx}/db/config/list');
