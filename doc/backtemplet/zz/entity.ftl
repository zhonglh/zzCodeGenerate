...
<#if !being.inParentClass>
    ...
    @EntityAttrFkAnnotation(group = "${being.javaName}",  groupName = "${being.columnComment}" ,   isFkId = true, dbColumnName = "id" , dbColumnType = "CHAR" , dbColumnLength = 32   , dbColumnNotNull = true , fkClass=${being.fkTableConfig.fullBoClassName!}.class)
    </#if>
