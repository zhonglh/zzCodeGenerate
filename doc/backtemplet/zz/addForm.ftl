            ...
            <div class="block-each block-each-another">
                ...
                <form id="editForm" action="" method="post">
                    ...
                    <#list table.pageChildColumns as childColumn>
                        <#list childColumn.tableBO.fkTables as fkTable>
                    ...
                    <#list table.pageChildColumns as childColumn>
                        ...
                        <table class="info-table">
                            ...
                            <#list childColumn.tableBO.tablePO.showColumnPages as listPage>
                                <#if listPage_index%2 ==0>
                                    <tr>
                                        <#if listPage.tableBO.tableName != table.tableName>
                                            ...
                                            <#if listPage?exists && listPage.columnConfig?exists>
                                                <#if listPage.element == 'text'  >
                                                    <input type="text" <#if listPage.required?exists && listPage.required == '1'>required="required"</#if> class="form-control input-sm <#if listPage.required?exists && listPage.required == '1'>required</#if>"
                                                           ...
                                                           value="${r"${"} m.${listPage.javaName} ${r"}"}" id="${childColumn.tableBO.simpleName}BOList_'+index+'_${listPage.javaName}" name="${childColumn.tableBO.simpleName}BOList['+index+'].${listPage.javaName}"
                                                ...
                                                <textarea <#if listPage.required?exists && listPage.required == '1'>required="required"</#if> class="form-control input-sm <#if listPage.required?exists && listPage.required == '1'>required</#if> "
                                                          name="${childColumn.tableBO.simpleName}BOList['+index+'].${listPage.javaName}" id="${listPage.javaName} " placeholder="请输入${listPage.columnComment}，${listPage.maxlength}字以内" maxlength="${listPage.maxlength}" rows="4">${r"${"} m.${listPage.javaName} ${r"}"}</textarea>
                                                    </div>
                                                <#elseif listPage.element == 'digits' >
                                                    <input type="text" <#if listPage.required?exists && listPage.required == '1'>required="required"</#if> class="form-control input-sm number  <#if listPage.required?exists && listPage.required == '1'>required</#if>"
                                                           placeholder="请输入${listPage.columnComment}" autocomplete="off"
                                                           value="${r"${"} m.${listPage.javaName} ${r"}"}" id="${childColumn.tableBO.simpleName}BOList_'+index+'_${listPage.javaName}" name="${childColumn.tableBO.simpleName}BOList['+index+'].${listPage.javaName}" step="1"
                                                            <#if listPage.max?exists>max="${listPage.max}" </#if> <#if listPage.min?exists>min="${listPage.min}" </#if> <#if listPage.minlength?exists>minlength="${listPage.minlength}" </#if> <#if listPage.maxlength?exists>maxlength="${listPage.maxlength}" </#if> />
                                                <#elseif listPage.element == 'number' >
                                                    <input type="text" <#if listPage.required?exists && listPage.required == '1'>required="required"</#if> class="form-control input-sm number fd-decimal2 <#if listPage.required?exists && listPage.required == '1'>required</#if>"
                                                           placeholder="请输入${listPage.columnComment}" autocomplete="off"
                                                           value="${r"${"} m.${listPage.javaName} ${r"}"}" id="${childColumn.tableBO.simpleName}BOList_'+index+'_${listPage.javaName}" name="${childColumn.tableBO.simpleName}BOList['+index+'].${listPage.javaName}" step="0.01"
                                                            <#if listPage.max?exists>max="${listPage.max}" </#if> <#if listPage.min?exists>min="${listPage.min}" </#if> <#if listPage.minlength?exists>minlength="${listPage.minlength}" </#if> <#if listPage.maxlength?exists>maxlength="${listPage.maxlength}" </#if> />
                                                <#elseif listPage.element == 'date' ||  listPage.element == 'timestamp' >
                                                    <div class="input-group">
                                                        <input type="text" <#if listPage.required?exists && listPage.required == '1'>required="required"</#if> class="form-control input-sm Wdate <#if listPage.required?exists && listPage.required == '1'>required</#if>"
                                                               placeholder="请输入${listPage.columnComment}" autocomplete="off"
                                                               onclick="WdatePicker({dateFmt: 'yyyy-MM-dd', el: '${listPage.javaName}'})"
                                                               value="${r"${"} m.${listPage.javaName} ${r"}"}" id="${childColumn.tableBO.simpleName}BOList_'+index+'_${listPage.javaName}" name="${childColumn.tableBO.simpleName}BOList['+index+'].${listPage.javaName}" readonly   />
                                                    </div>
                                                ...
                                                <#elseif listPage.element == 'radio' || listPage.element == 'checkbox' || listPage.element == 'select' >
                                                    <select id="${childColumn.tableBO.simpleName}BOList_'+index+'_${listPage.javaName}"  name="${childColumn.tableBO.simpleName}BOList['+index+'].${listPage.javaName}" <#if listPage.required?exists && listPage.required == '1'>required="required"</#if> style="width:98%">
                                                        <option value="" ></option>
                                                        <c:forEach items="${r"${"} ${listPage.columnConfig.dictType}_dicts ${r"}"}" var="dict">
                                                            <option value="${r"${"} dict.dictVal ${r"}"}" <c:if test="${r"${"} dict.dictVal == m.${listPage.javaName} ${r"}"}">selected</c:if>>${r"${"} dict.dictName  ${r"}"}</option>
                                                        </c:forEach>
                                                    </select>
                                            ...
                                            <#elseif listPage?exists && listPage.exColumn?exists>
                                                <#if listPage.element == 'openwin' >
                                                    <c:if test="${r"${"} fn:indexOf(allQueryString,'&${listPage.exColumn.originalJavaName}=') >=0 ${r"}"}">
                                                        <input type="text" class="form-control input-sm" name="${childColumn.tableBO.simpleName}BOList['+index+'].${listPage.javaName}" id="${childColumn.tableBO.simpleName}BOList_'+index+'_${listPage.javaName}"  value="${r"${"} m.${listPage.javaName} ${r"}"}" readonly>
                                                    </c:if>
                                                    <c:if test="${r"${"} fn:indexOf(allQueryString,'&${listPage.exColumn.originalJavaName}=') < 0 ${r"}"}">
                                                        <div class="input-group">
                                                            <input type="hidden" name="${listPage.exColumn.originalJavaName}" id="${listPage.exColumn.originalJavaName}" value="${r"${"} m.${listPage.exColumn.originalJavaName} ${r"}"}">
                                                            <input type="text" name="${childColumn.tableBO.simpleName}BOList['+index+'].${listPage.javaName}" id="${childColumn.tableBO.simpleName}BOList_'+index+'_${listPage.javaName}" value="${r"${"} m.${listPage.javaName} ${r"}"}" <#if listPage.required?exists && listPage.required == '1'>required="required"</#if> class="form-control input-sm ${listPage.javaName} " placeholder="请选择${listPage.columnComment}" style="cursor: pointer;" readonly="readonly">
                                                            <div class="input-group-btn">
                                                                <button type="button"
                                                                        class="btn btn-primary btn-sm ${listPage.javaName}">
                                                                    <svg class="icon" aria-hidden="true">
                                                                        <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                             xlink:href="#icon-sousuo">
                                                                        </use>
                                                                ...
                                                                <button type="button" id="clear${listPage.exColumn.originalJavaName?cap_first}"
                                                                        class="btn btn-primary btn-sm">
                                                                    <svg class="icon" aria-hidden="true">
                                                                        <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                             xlink:href="#icon-close">
                                        ...
                                        <#if listPage_has_next>
                                            <#assign nextPage=childColumn.tableBO.tablePO.showColumnPages[listPage_index+1]>
                                            <#if nextPage.tableBO.tableName != table.tableName>
                                            <th>${nextPage.columnComment}<#if nextPage.required?exists && nextPage.required == '1'><font color="red">*</font></#if></th>
                                            <td>
                                                <#if nextPage?exists && nextPage.columnConfig?exists>
                                                    <#if nextPage.element == 'text'  >
                                                        <input type="text" <#if nextPage.required?exists && nextPage.required == '1'>required="required"</#if> class="form-control input-sm <#if nextPage.required?exists && nextPage.required == '1'>required</#if>"
                                                               placeholder="请输入${nextPage.columnComment}" autocomplete="off"
                                                               value="${r"${"} m.${nextPage.javaName} ${r"}"}" id="${childColumn.tableBO.simpleName}BOList_'+index+'_${nextPage.javaName}" name="${childColumn.tableBO.simpleName}BOList['+index+'].${nextPage.javaName}"
                                                                <#if nextPage.max?exists>max="${nextPage.max}" </#if> <#if nextPage.min?exists>min="${nextPage.min}" </#if> <#if nextPage.minlength?exists>minlength="${nextPage.minlength}" </#if> <#if nextPage.maxlength?exists>maxlength="${nextPage.maxlength}" </#if> />
                                                    <#elseif nextPage.element == 'textarea' >
                                                        <div class="info-detail">
                                            <textarea <#if nextPage.required?exists && nextPage.required == '1'>required="required"</#if> class="form-control input-sm <#if nextPage.required?exists && nextPage.required == '1'>required</#if> "
                                                      name="${childColumn.tableBO.simpleName}BOList['+index+'].${nextPage.javaName}" placeholder="请输入${nextPage.columnComment}，${nextPage.maxlength}字以内" maxlength="${nextPage.maxlength}" rows="4">${r"${"} m.${nextPage.javaName} ${r"}"}</textarea>
                                                        </div>
                                                    <#elseif nextPage.element == 'digits' >
                                                        <input type="text" <#if nextPage.required?exists && nextPage.required == '1'>required="required"</#if> class="form-control input-sm number  <#if nextPage.required?exists && nextPage.required == '1'>required</#if>"
                                                               placeholder="请输入${nextPage.columnComment}" autocomplete="off"
                                                               value="${r"${"} m.${nextPage.javaName} ${r"}"}" id="${childColumn.tableBO.simpleName}BOList_'+index+'_${nextPage.javaName}" name="${childColumn.tableBO.simpleName}BOList['+index+'].${nextPage.javaName}" step="1"
                                                                <#if nextPage.max?exists>max="${nextPage.max}" </#if> <#if nextPage.min?exists>min="${nextPage.min}" </#if> <#if nextPage.minlength?exists>minlength="${nextPage.minlength}" </#if> <#if nextPage.maxlength?exists>maxlength="${nextPage.maxlength}" </#if> />
                                                    <#elseif nextPage.element == 'number' >
                                                        <input type="text" <#if nextPage.required?exists && nextPage.required == '1'>required="required"</#if> class="form-control input-sm number fd-decimal2 <#if nextPage.required?exists && nextPage.required == '1'>required</#if>"
                                                               placeholder="请输入${nextPage.columnComment}" autocomplete="off"
                                                               value="${r"${"} m.${nextPage.javaName} ${r"}"}" id="${childColumn.tableBO.simpleName}BOList_'+index+'_${nextPage.javaName}" name="${childColumn.tableBO.simpleName}BOList['+index+'].${nextPage.javaName}" step="0.01"
                                                                <#if nextPage.max?exists>max="${nextPage.max}" </#if> <#if nextPage.min?exists>min="${nextPage.min}" </#if> <#if nextPage.minlength?exists>minlength="${nextPage.minlength}" </#if> <#if nextPage.maxlength?exists>maxlength="${nextPage.maxlength}" </#if> />
                                                    <#elseif nextPage.element == 'date' ||  nextPage.element == 'timestamp' >
                                                        <div class="input-group">
                                                            <input type="text" <#if nextPage.required?exists && nextPage.required == '1'>required="required"</#if> class="form-control input-sm Wdate <#if nextPage.required?exists && nextPage.required == '1'>required</#if>"
                                                                   placeholder="请输入${nextPage.columnComment}" autocomplete="off"
                                                                   onclick="WdatePicker({dateFmt: 'yyyy-MM-dd', el: '${nextPage.javaName}'})"
                                                                   value="${r"${"} m.${nextPage.javaName} ${r"}"}" id="${childColumn.tableBO.simpleName}BOList_'+index+'_${nextPage.javaName}" name="${childColumn.tableBO.simpleName}BOList['+index+'].${nextPage.javaName}" readonly   />
                                                        </div>
                                                    <#elseif nextPage.element == 'email' >
                                                        <input type="email" <#if nextPage.required?exists && nextPage.required == '1'>required="required"</#if> class="form-control input-sm <#if nextPage.required?exists && nextPage.required == '1'>required</#if>"
                                                               placeholder="请输入${nextPage.columnComment}" autocomplete="off"
                                                    ...
                                                    <#elseif nextPage.element == 'url' >
                                                        <input type="url" <#if nextPage.required?exists && nextPage.required == '1'>required="required"</#if> class="form-control input-sm <#if nextPage.required?exists && nextPage.required == '1'>required</#if>"
                                                               ...
                                                               value="${r"${"} m.${nextPage.javaName} ${r"}"}" id="${childColumn.tableBO.simpleName}BOList_'+index+'_${nextPage.javaName}" name="${childColumn.tableBO.simpleName}BOList['+index+'].${nextPage.javaName}"
                                                                <#if nextPage.max?exists>max="${nextPage.max}" </#if> <#if nextPage.min?exists>min="${nextPage.min}" </#if> <#if nextPage.minlength?exists>minlength="${nextPage.minlength}" </#if> <#if nextPage.maxlength?exists>maxlength="${nextPage.maxlength}" </#if> />
                                                    <#elseif nextPage.element == 'radio' || nextPage.element == 'checkbox' || nextPage.element == 'select' >
                                                        <select id="${childColumn.tableBO.simpleName}BOList_'+index+'_${nextPage.javaName}"  name="${childColumn.tableBO.simpleName}BOList['+index+'].${nextPage.javaName}" <#if nextPage.required?exists && nextPage.required == '1'>required="required"</#if> style="width:98%">
                                                            <option value="" ></option>
                                                            <c:forEach items="${r"${"} ${nextPage.columnConfig.dictType}_dicts ${r"}"}" var="dict">
                                                                <option value="${r"${"} dict.dictVal ${r"}"}" <c:if test="${r"${"} dict.dictVal == m.${nextPage.javaName} ${r"}"}">selected</c:if>>${r"${"} dict.dictName ${r"}"}</option>
                                                            </c:forEach>
                                                ...
                                                <#elseif nextPage?exists && nextPage.exColumn?exists>
                                                    <#if nextPage.element == 'openwin' >
                                                        <c:if test="${r"${"} fn:indexOf(allQueryString,'&${nextPage.exColumn.originalJavaName}=') >= 0 ${r"}"}">
                                                            <input type="text" class="form-control input-sm" name="${childColumn.tableBO.simpleName}BOList['+index+'].${nextPage.javaName}" id="${childColumn.tableBO.simpleName}BOList_'+index+'_${nextPage.javaName}"  value="${r"${"} m.${nextPage.javaName} ${r"}"}" readonly>
                                                        </c:if>
                                                        <c:if test="${r"${"} fn:indexOf(allQueryString,'&${nextPage.exColumn.originalJavaName}=') < 0 ${r"}"}">
                                                            <div class="input-group">
                                                                <input type="hidden" name="${nextPage.exColumn.originalJavaName}" id="${nextPage.exColumn.originalJavaName}" value="${r"${"} m.${nextPage.exColumn.originalJavaName} ${r"}"}" >
                                                                <input type="text" name="${childColumn.tableBO.simpleName}BOList['+index+'].${nextPage.javaName}" id="${childColumn.tableBO.simpleName}BOList_'+index+'_${nextPage.javaName}" value="${r"${"} m.${nextPage.javaName} ${r"}"}" <#if nextPage.required?exists && nextPage.required == '1'>required="required"</#if> class="form-control input-sm ${nextPage.javaName} " placeholder="请选择${nextPage.columnComment}" style="cursor: pointer;" readonly="readonly">
                                                                <div class="input-group-btn">
                                                                    <button type="button"  class="btn btn-primary btn-sm ${nextPage.javaName}">
                                                                        <svg class="icon" aria-hidden="true">
                                                                            <use xmlns:xlink="http://www.w3.org/1999/xlink"
                        ...
                        <#else >
                            ...
                            <div class="${childColumn.tableBO.fullUpperResourceName?uncap_first}">
                                    ...
                                    <tr>
                                        ...
                                        <#if childColumn.tableBO.tablePO.listColumnPages?exists>
                                            <#list childColumn.tableBO.tablePO.listColumnPages as listPage>
                                                <#if listPage.exColumn?exists && listPage.exColumn.originalColumn.tableName != table.tableName>
...
<script language="JavaScript">
    $(function() {
        ...
        $("#temp${fkTable.fullUpperResourceName}").Open${fkTable.fullUpperResourceName?cap_first}SelectWin({
            ...
            $(temp${fkTable.fullUpperResourceName?cap_first}).val(row.${fkTable.businessNameCamelCase?cap_first});
    ...
    <#if table.childListDicts?exists>
    ...
    function clear${fkTable.fullUpperResourceName}(theTabelId , theTableJavaName ,obj ,index){
        if(obj != null && obj != undefined){
            ...
            costTableRows(tableId , tableJavaName , temp${listPage.exColumn.originalColumn.fkTableConfig.fullUpperResourceName}Index);
        }
    }
    </#if>
    </#list>
    ...
    function ${childColumn.tableBO.fullUpperResourceName?uncap_first}_${listPage.javaName}Fmt(val, row,index){
        ...
        <#elseif listPage.exColumn?exists && listPage.exColumn.originalColumn.columnIsfk == '1'>
            ...
            html += '<input type="text"  class="form-control input-sm ${listPage.exColumn.javaName}" onclick="open${listPage.exColumn.originalColumn.fkTableConfig.fullUpperResourceName}(\'tableData-${childColumn.tableBO.simpleName}\',\'${childColumn.tableBO.simpleName}BOList\',this,'+index+')" required="required" value="'+row.${listPage.exColumn.javaName}+'" id="${childColumn.tableBO.simpleName}BOList_'+index+'_${listPage.exColumn.javaName}"  name="${childColumn.tableBO.simpleName}BOList['+index+'].${listPage.exColumn.javaName}"  onblur="costTableRows(\'tableData-${childColumn.tableBO.simpleName}\' , \'${childColumn.tableBO.simpleName}BOList\' , '+index+')" placeholder="请选择开户行" readonly >';
            html += '<div class="input-group-btn">';
            html += '<div class="btn btn-primary btn-sm" onclick="open${listPage.exColumn.originalColumn.fkTableConfig.fullUpperResourceName}(\'tableData-${childColumn.tableBO.simpleName}\', \'${childColumn.tableBO.simpleName}BOList\',document.getElementById(\'${childColumn.tableBO.simpleName}BOList_'+index+'_${listPage.exColumn.javaName}\'),'+index+')">';
            html += '<svg class="icon" aria-hidden="true">';
            html += '<use xmlns:xlink="http://www.w3.org/1999/xlink"  xlink:href="#icon-sousuo"></use>';
            html += '</svg>';
            html += '</div>';
            html += '<div class="btn btn-primary btn-sm" onclick="clear${listPage.exColumn.originalColumn.fkTableConfig.fullUpperResourceName}(\'tableData-${childColumn.tableBO.simpleName}\', \'${childColumn.tableBO.simpleName}BOList\',document.getElementById(\'${childColumn.tableBO.simpleName}BOList_'+index+'_${listPage.exColumn.javaName}\'),'+index+')"  >';
            html += '<svg class="icon" aria-hidden="true">';
        ...
        <#else >
            ...
            'placeholder="请输入${listPage.columnComment}" autocomplete="off" id="${childColumn.tableBO.simpleName}BOList_'+index+'_${listPage.javaName}" name="${childColumn.tableBO.simpleName}BOList['+index+'].${listPage.javaName}"'+
            '<#if listPage.max?exists>max="${listPage.max}" </#if> <#if listPage.min?exists>min="${listPage.min}" </#if> <#if listPage.minlength?exists>minlength="${listPage.minlength}" </#if> <#if listPage.maxlength?exists>maxlength="${listPage.maxlength}" </#if> />';
    ...
    function doAddFundAccount() {
        var rows = $('#tableData-${childColumn.tableBO.fullUpperResourceName?uncap_first}').datagrid("getRows");
        rows.push({ <#list childColumn.tableBO.tablePO.showPages as listPage>#{listPage.javaName} : "" <#if listPage_has_next>,</#if></#list> });
        $('#tableData-${childColumn.tableBO.fullUpperResourceName?uncap_first}').datagrid("loadData",rows);
    }
    </#if>
    </#list>
