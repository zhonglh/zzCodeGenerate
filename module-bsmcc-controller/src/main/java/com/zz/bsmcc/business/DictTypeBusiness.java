...
public class DictTypeBusiness {
    ...
    public static void buildDictType(TcgProjectBO projectBO, Map<String, String> dictTypeMap) {
        ...
        for(Map.Entry<String,String> entry : dictTypeMap.entrySet()){
            ...
            sb.append("\n */");
            sb.append("\n").append("public enum Enum").append(StringFormatKit.toCapitalizeCamelCase(entry.getKey())).append(" implements EnumBase {");
            ...
            String result = FreemarkerUtils.renderString( sb.toString() , model);
