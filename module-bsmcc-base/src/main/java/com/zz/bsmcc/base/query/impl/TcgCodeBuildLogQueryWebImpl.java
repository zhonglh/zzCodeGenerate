...
/**
 * 代码生成记录 用于装载用户在查询时提交的数据
 * 链式查询
 * @author Administrator
 * @date 2018-8-5 15:15:56
 */
public class TcgCodeBuildLogQueryWebImpl<PK extends Serializable> extends TcgCodeBuildLogAbstractQueryImpl<PK> implements Serializable {
            ...
            private PK templetGroupId_IN;
            private PK templetGroupId_NOTIN;
        ...
        ;
                ...
                public PK getTempletGroupId() {
                    return templetGroupId;
                }


                public void setTempletGroupId(PK templetGroupId) {
                    this.templetGroupId = templetGroupId;
                }


                public PK getTempletGroupId_NE() {
                return templetGroupId_NE;
                }


                public void setTempletGroupId_NE(PK templetGroupId_NE) {
                this.templetGroupId_NE = templetGroupId_NE;
                }
                ...
                public PK getTempletGroupId_IN() {
                    return templetGroupId_IN;
                }

                public void setTempletGroupId_IN(PK templetGroupId_IN) {
                    this.templetGroupId_IN = templetGroupId_IN;
                }

                public PK getTempletGroupId_NOTIN() {
                    return templetGroupId_NOTIN;
                }

                public void setTempletGroupId_NOTIN(PK templetGroupId_NOTIN) {
                    this.templetGroupId_NOTIN = templetGroupId_NOTIN;
                }
