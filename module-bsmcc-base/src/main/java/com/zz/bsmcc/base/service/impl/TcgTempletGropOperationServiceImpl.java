...
*/
@Service
public class TcgTempletGropOperationServiceImpl extends BaseServiceImpl<TcgTempletGropOperationEntity,String> implements TcgTempletGropOperationService {
